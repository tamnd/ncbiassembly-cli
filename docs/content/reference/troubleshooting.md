...
Most of these come down to network reality or how ncbiassembly serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ncbiassembly rate-limits like any public site. ncbiassembly already paces
...
Where a surface is gated, ncbiassembly reads a cookie or token you supply
...
`ncbiassembly`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ncbiassembly actually did
