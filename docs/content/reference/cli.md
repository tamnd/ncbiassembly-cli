...
```
ncbiassembly <command> [arguments] [flags]
```

Run `ncbiassembly <command> --help` for the full flag list on any command. This
...
per operation you declare in `ncbiassembly/domain.go`.
