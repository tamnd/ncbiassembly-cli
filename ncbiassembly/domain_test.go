...
// HTTP behaviour is covered in ncbiassembly_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ncbiassembly://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ncbiassembly", "about")
	if err != nil || got.String() != "ncbiassembly://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ncbiassembly://page/about", got.String(), err)
	}
}
